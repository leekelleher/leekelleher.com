...
?>
	<main>
		<article>
			...
			<p>If we're connected on <a href="https://twitter.com/leekelleher" rel="me">Twitter</a>, Facebook, or LinkedIn, then I'm happy to be contacted using the direct message features of thoses services.<br><em>(Less so on Facebook, as I don't have the Messenger app installed anymore.)</em></p>
			...
			<p>I did used to have a contact form on this page, but it was very much abused by spammers, so my simpler option to battling with with them was to remove it and offer folk the alternative methods to contact me.</p>
		</article>
	</main>
